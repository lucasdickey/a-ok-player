    ...
    try {
      ...
      if (error) {
        ...
        if (error.message && error.message.includes("Email not confirmed")) {
          ...
          setErrorMessage("Your email has not been verified. Please check your inbox for a verification link or click below to resend the verification email.")
  ...
  const handleResendVerification = async () => {
    ...
    try {
      ...
      if (error) {
        ...
        setErrorMessage("Verification email has been resent. Please check your inbox.")
      }
    } catch (error: any) {
      setErrorMessage(`An error occurred: ${error.message || "Please try again later"}`)
    } finally {
        ...
        <CardContent className="space-y-4">
          {errorMessage && (
            <Alert variant={needsVerification ? "default" : "destructive"}>
              ...
              <AlertTitle>{needsVerification ? "Email Verification Required" : "Login Error"}</AlertTitle>
